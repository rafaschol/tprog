...
public class CrearActividadDeportiva extends JInternalFrame {
    ...
    private void altaActividadActionPerformed(ActionEvent e) {
    	...
    	if (esValido()) {
    		try {
    			...
    			JOptionPane.showMessageDialog(this, "Se cre� la actividad deportiva correctamente.");
    			cerrarFormulario();
    ...
    private boolean esValido() {
    	...
    	if (institucionComboBox.getSelectedIndex() == -1) {
    		...
    		JOptionPane.showMessageDialog(this, "La fecha de alta ingresada no es v�lida.", null, JOptionPane.ERROR_MESSAGE);
    		return false;
    	}
    	else {
    		return true;
