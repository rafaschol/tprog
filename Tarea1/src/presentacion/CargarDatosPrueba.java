...
public class CargarDatosPrueba {
	...
	public void cargarSocios() {
		try {
			...
			controladorUsuario.altaSocio("andy", "Andr�s", "Roman", "chino@gmail.org.uy", new Date(76, 2, 17));
	...
	public void cargarProfesores() {
		try {
			controladorUsuario.altaProfesor("viktor", "Victor", "Perez", "vperez@fuerza.com", new Date(77, 0, 1), "Fuerza Bruta",
					"Victor es un apasionado de los m�sculos. Sus clases son organizadas en funci�n de distintos aparatos y pesas con el objetivo de desarrollar m�sculos",
					"Victor naci� en Moscow en 1977. En el a�o 2005 emigr� a Uruguay luego de quedar encantado con el pa�s en un viaje tur�stico.",
					"www.vikgym.com");
			controladorUsuario.altaProfesor("denis", "Denis", "Miguel", "den80@fuerza.com", new Date(80, 5, 14), "Tel�n",
			...
			controladorUsuario.altaProfesor("clazar", "Carlos", "Lazaro", "claz4r0@hotmail.com", new Date(53, 5, 22), "Instituto Natural",
					"Carlos es un profesor muy divertido cuyas clases de aer�bica est�n cargadas de energ�a.",
					"El inter�s por la actividad f�sica llevo a Carlos a dejar su trabajo en un estudio contable y abrir su propio gimnasio.",
					"www.enforma.co");
			controladorUsuario.altaProfesor("TheBoss", "Bruno", "Sosa", "bruceTheBoss@gmail.com", new Date(49, 8, 23), "Fuerza Bruta",
					...
					"Bruno, mejor conocido como Bruce en el ring, compiti� como boxeador entre los a�os 60s y 70s.",
					"www.bruce.net");
			controladorUsuario.altaProfesor("Nelson", "Luis", "Nelson", "nelson@hotmail.com", new Date(98, 0, 1), "Tel�n",
					"Profesor de nataci�n. Especializado en braza y mariposa.",
					"",
					"www.nelson.uy");
			controladorUsuario.altaProfesor("lale", "Laura", "Leyes", "la_le@outlook.com", new Date(87, 1, 14), "Tel�n",
					"Luego de una exitosa carrera como jugadora de futbol profesional. Laura dedica sus clases a ense�ar t�cticas de futbol",
			...
			controladorUsuario.altaProfesor("prisc", "Priscila", "Pappo", "pripa@gmail.com", new Date(81, 7, 13), "Olympic",
					"Laura tiene un gran inter�s por los deportes ol�mpicos.",
					"",
					"www.pi314.net");
			controladorUsuario.altaProfesor("dagost", "Daiana", "Agostini", "d_1940_ago@gmail.com", new Date(40, 2, 5), "Olympic",
					...
					"",
					"www.dygym.com");
			controladorUsuario.altaProfesor("aldo", "Aldo", "Vivaldi", "aldo@outlook.com", new Date(52, 6, 17), "Tel�n",
					"Dada su gran estatura Aldo siempre jug� al basquetbol, hoy se dedica a ense�arlo.",
					"",
					"www.sportsaldo.net");
		} catch (UsuarioRepetidoException | MailRepetidoException e) {
			e.printStackTrace();
	...
	public void cargarInstituciones() {
		try {
			controladorInstitucion.altaInstitucionDeportiva("Instituto Natural",
					"Clases de gimnasia, aer�bica, spinning y yoga.",
			...
			controladorInstitucion.altaInstitucionDeportiva("Tel�n",
	...
	public void cargarActividadesDeportivas() {
		try {
			...
			controladorInstitucion.altaActividadDeportiva("Tel�n", "Voleibol",
					"Voleibol en todas sus formas",
					120, (float) 750.0, new Date(121, 3, 20));
			controladorInstitucion.altaActividadDeportiva("Instituto Natural", "Aer�bica",
			...
			controladorInstitucion.altaActividadDeportiva("Fuerza Bruta", "Kickboxing",
					"En busca del nuevo campe�n de boxeo.",
					100, (float) 980.0, new Date(121, 5, 7));
			controladorInstitucion.altaActividadDeportiva("Tel�n", "Atletismo",
					"100m , 200m, postas y carreras con obstaculos.",
					150, (float) 500.0, new Date(121, 6, 8));
			controladorInstitucion.altaActividadDeportiva("Tel�n", "Basquetbol",
					"Espect�culo conmemorando los 30 a�os de Violeta.",
	...
	public void cargarClases() {
		try {
			...
			controladorInstitucion.altaClase("Aer�bica ni�os", new Date(121, 7, 15, 16, 30), 5, 10, "https://www.inatural.com/aeroni", new Date(121, 4, 30), "clazar", "Aer�bica");
			controladorInstitucion.altaClase("Aer�bico adulto mayor", new Date(121, 7, 31, 19, 30), 5, 12, "https://www.inatural.com/aeroam", new Date(121, 4, 30), "clazar", "Aer�bica");
			controladorInstitucion.altaClase("Aer�bica", new Date(121, 8, 30, 20, 0), 5, 20, "https://www.inatural.com/aerogral", new Date(121, 4, 30), "clazar", "Aer�bica");
			...
			controladorInstitucion.altaClase("M�sculos para boxeo", new Date(121, 9, 15, 20, 0), 1, 5, "https://www.musculos.com/muscbox", new Date(121, 5, 7), "viktor", "Kickboxing");
	...
	public void cargarRegistrosClases() {
		try {
			...
			controladorUsuario.registrarSocio("m1k4", "Aer�bica ni�os", "Aer�bica", false, null, new Date(121, 6, 19));
			controladorUsuario.registrarSocio("Emi71", "Aer�bico adulto mayor", "Aer�bica", false, null, new Date(121, 7, 17));
			controladorUsuario.registrarSocio("guille", "Aer�bico adulto mayor", "Aer�bica", false, null, new Date(121, 7, 20));
			controladorUsuario.registrarSocio("andy", "Aer�bico adulto mayor", "Aer�bica", false, null, new Date(121, 7, 23));
			controladorUsuario.registrarSocio("caro", "Aer�bica", "Aer�bica", false, null, new Date(121, 7, 15));
			controladorUsuario.registrarSocio("euge", "Aer�bica", "Aer�bica", false, null, new Date(121, 7, 26));
			...
			controladorUsuario.registrarSocio("Emi71", "M�sculos para boxeo", "Kickboxing", false, null, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("caro", "M�sculos para boxeo", "Kickboxing", false, null, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("euge", "M�sculos para boxeo", "Kickboxing", false, null, new Date(121, 8, 1));
			controladorUsuario.registrarSocio("sergiop", "M�sculos para boxeo", "Kickboxing", false, null, new Date(121, 8, 5));
	...
	public void cargarCuponeras() {
		try {
			...
			controladorCuponera.altaCuponera("M�sculos",
					"Pesas.",
	...
	public void cargarActividadesCuponeras() {
		...
		try {
			...
			controladorCuponera.agregarActividadACuponera("Gimnasia", "Aer�bica", 2);
			controladorCuponera.agregarActividadACuponera("Gimnasia", "Aparatos y pesas", 8);
			controladorCuponera.agregarActividadACuponera("M�sculos", "Kickboxing", 11);
			controladorCuponera.agregarActividadACuponera("M�sculos", "Aparatos y pesas", 12);
