...
public class CargarDatosPrueba {
	...
	public void cargarRegistrosClases() {
		try {
			controladorUsuario.registrarSocio("caro", "Calistenia", "Aparatos y pesas", false, new Date(121, 3, 9));
			controladorUsuario.registrarSocio("sergiop", "Calistenia", "Aparatos y pesas", false, new Date(121, 3, 10));
			controladorUsuario.registrarSocio("andy", "Calistenia", "Aparatos y pesas", false, new Date(121, 3, 12));
			controladorUsuario.registrarSocio("andy", "Peso libre", "Aparatos y pesas", false, new Date(121, 3, 15));
			controladorUsuario.registrarSocio("tonyp", "Peso libre", "Aparatos y pesas", false, new Date(121, 3, 20));
			controladorUsuario.registrarSocio("caro", "Peso libre", "Aparatos y pesas", false, new Date(121, 3, 25));
			controladorUsuario.registrarSocio("m1k4", "Peso libre", "Aparatos y pesas", false, new Date(121, 3, 28));
			controladorUsuario.registrarSocio("charly", "Aparatos", "Aparatos y pesas", false, new Date(121, 3, 16));
			controladorUsuario.registrarSocio("caro", "Aparatos", "Aparatos y pesas", false, new Date(121, 4, 15));
			controladorUsuario.registrarSocio("m1k4", "Aparatos", "Aparatos y pesas", false, new Date(121, 4, 20));
			controladorUsuario.registrarSocio("Emi71", "Voleibol", "Voleibol", false, new Date(121, 4, 5));
			controladorUsuario.registrarSocio("euge", "Voleibol", "Voleibol", false, new Date(121, 4, 10));
			controladorUsuario.registrarSocio("sergiop", "Voleibol", "Voleibol", false, new Date(121, 4, 15));
			controladorUsuario.registrarSocio("tonyp", "Voleibol", "Voleibol", false, new Date(121, 4, 20));
			controladorUsuario.registrarSocio("guille", "Braza", "Voleibol", false, new Date(121, 5, 8));
			controladorUsuario.registrarSocio("euge", "Braza", "Voleibol", false, new Date(121, 5, 13));
			controladorUsuario.registrarSocio("m1k4", "Braza", "Voleibol", false, new Date(121, 5, 25));
			controladorUsuario.registrarSocio("charly", "Mariposa", "Voleibol", false, new Date(121, 6, 5));
			controladorUsuario.registrarSocio("sergiop", "Mariposa", "Voleibol", false, new Date(121, 6, 11));
			controladorUsuario.registrarSocio("andy", "Mariposa", "Voleibol", false, new Date(121, 6, 18));
			controladorUsuario.registrarSocio("m1k4", "Aeróbica niños", "Aeróbica", false, new Date(121, 6, 19));
			controladorUsuario.registrarSocio("Emi71", "Aeróbico adulto mayor", "Aeróbica", false, new Date(121, 7, 17));
			controladorUsuario.registrarSocio("guille", "Aeróbico adulto mayor", "Aeróbica", false, new Date(121, 7, 20));
			controladorUsuario.registrarSocio("andy", "Aeróbico adulto mayor", "Aeróbica", false, new Date(121, 7, 23));
			controladorUsuario.registrarSocio("caro", "Aeróbica", "Aeróbica", false, new Date(121, 7, 15));
			controladorUsuario.registrarSocio("euge", "Aeróbica", "Aeróbica", false, new Date(121, 7, 26));
			controladorUsuario.registrarSocio("andy", "Boxeo I", "Kickboxing", false, new Date(121, 6, 19));
			controladorUsuario.registrarSocio("tonyp", "Boxeo I", "Kickboxing", false, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("m1k4", "Boxeo I", "Kickboxing", false, new Date(121, 7, 24));
			controladorUsuario.registrarSocio("sergiop", "Boxeo II", "Kickboxing", false, new Date(121, 7, 1));
			controladorUsuario.registrarSocio("guille", "Boxeo II", "Kickboxing", false, new Date(121, 7, 30));
			controladorUsuario.registrarSocio("Emi71", "Músculos para boxeo", "Kickboxing", false, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("caro", "Músculos para boxeo", "Kickboxing", false, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("euge", "Músculos para boxeo", "Kickboxing", false, new Date(121, 8, 1));
			controladorUsuario.registrarSocio("sergiop", "Músculos para boxeo", "Kickboxing", false, new Date(121, 8, 5));
			controladorUsuario.registrarSocio("guille", "100 M", "Atletismo", false, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("charly", "100 M", "Atletismo", false, new Date(121, 8, 3));
			controladorUsuario.registrarSocio("Emi71", "200 M", "Atletismo", false, new Date(121, 7, 16));
			controladorUsuario.registrarSocio("charly", "200 M", "Atletismo", false, new Date(121, 8, 6));
			controladorUsuario.registrarSocio("caro", "Posta", "Atletismo", false, new Date(121, 8, 1));
			controladorUsuario.registrarSocio("sergiop", "Basquet I", "Basquetbol", false, new Date(121, 8, 16));
			controladorUsuario.registrarSocio("Emi71", "Basquet I", "Basquetbol", false, new Date(121, 8, 20));
			controladorUsuario.registrarSocio("tonyp", "Basquet I", "Basquetbol", false, new Date(121, 8, 31));
			controladorUsuario.registrarSocio("andy", "Basquet II", "Basquetbol", false, new Date(121, 8, 16));
			controladorUsuario.registrarSocio("tonyp", "Basquet II", "Basquetbol", false, new Date(121, 8, 20));
			controladorUsuario.registrarSocio("caro", "Basquet II", "Basquetbol", false, new Date(121, 9, 2));
		} catch (CuposAgotadosException | SocioRegistradoException e) {
			e.printStackTrace();
		}
	}
