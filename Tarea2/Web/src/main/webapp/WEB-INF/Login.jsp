  ...
  <main class="form-page" id="login-page">
    ...
    <form method="post" class="text-center py-5 px-4 m-3 bg-white shadow rounded">
      ...
      <div class="form-floating mb-3">
        <input type="text" class="form-control${ loginError != null ? ' is-invalid' : '' }" id="emailInput" name="email" placeholder="Correo electrónico" aria-describedly="invalidUsername">
        <label for="emailInput">Nickname o correo electrónico</label>
      ...
      <p class="mt-3">¿No tienes una cuenta? <a href="registro" class="text-decoration-none">Regístrate</a></p>
    </form>
